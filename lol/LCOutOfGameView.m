...
- (NIAttributedLabel *)pullReloadDescLabel {
  if (nil == _pullReloadDescLabel) {
    ...
    _pullReloadDescLabel.font = [UIFont systemFontOfSize:12];
    _pullReloadDescLabel.text = NSLocalizedString(@"pull_to_reload_desc", nil);
    [_pullReloadDescLabel insertImage:[UIImage imageNamed:@"refresh.png"] atIndex:0 margins:UIEdgeInsetsMake(2, 2, 2, 7)];
